...
describe ReflectionsController do
  ...
  describe "manual tests" do
    context "after creating 30 reflections" do
      before(:each) { FactoryGirl.create_list(:reflection, 30) }
  
      describe "test" do
        it "should have thirty devotions" do
          expect(Reflection.all.length).to eq 30
        end
    ...
    describe "POST create" do
      ...
      describe "with invalid params" do
        it "assigns a newly created but unsaved reflection as @reflection" do
          ...
          post :create, {:reflection => { "text" => "invalid value" }}, valid_session
          assigns(:reflection).should be_a_new(Reflection)
        end
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "updates the requested reflection" do
          ...
          Reflection.any_instance.should_receive(:update).with({ "text" => "MyText" })
          put :update, {:id => reflection.to_param, :reflection => { "text" => "MyText" }}, valid_session
        end
      ...
      describe "with invalid params" do
        it "assigns the reflection as @reflection" do
          ...
          # Trigger the behavior that occurs when invalid params are submitted
          Reflection.any_instance.stub(:save).and_return(false)
          put :update, {:id => reflection.to_param, :reflection => { "text" => "invalid value" }}, valid_session
          assigns(:reflection).should eq(reflection)
        end
